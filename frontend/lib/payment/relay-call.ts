...
const PATH_BY_ACTION: Record<string, string> = {
  ...
  "set-appeals": "/api/relay/set-appeals",
  "file-appeal": "/api/relay/file-appeal",
  "set-human-decision": "/api/relay/set-human-decision",
  "set-report-human-decision": "/api/relay/set-report-human-decision",
